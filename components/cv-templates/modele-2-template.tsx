...
export default function ModerneTemplateFirst({ cvData,
  ...
  const gradientBg = includeColors ? "bg-blue-600" : "bg-gray-800"
        ...
        {!previewOnly && (
          <div>
            ...
            >
              ...
              <div className="relative z-10 text-center space-x-4 flex flex-row">
                      ...
                      >
                        ...
                        <div
                          className={`absolute left-2 top-6 w-0.5 h-full ${
                            includeColors ? "bg-blue-200" : "bg-gray-200"
                          }`}
                        ></div>
              ...
              {cvData.formations.length > 0 && (
                <section className={exportMode ? "break-inside-avoid" : ""}>
                  <div className="flex items-center gap-3 mb-6">
                    <div
                      className={`p-2 ${
                        includeColors ? "bg-blue" : "bg-gray-600"
                      } rounded-lg`}
                    >
                      <Award className="h-5 w-5 text-white" />
                    </div>
