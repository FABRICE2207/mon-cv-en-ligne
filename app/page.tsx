...
import { FileText, Users, Zap, ChevronRight, Check, Star, MessageSquare, HelpCircle, LayoutTemplate, PenTool, Download, Share2, ArrowRight, BadgeCheck, Menu, X } from "lucide-react"
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className={`fixed w-full top-0 z-50 transition-all duration-300 ${scrolled ? 'bg-white shadow-md py-2' : 'bg-white/95 backdrop-blur-sm py-4'} border-b`}>
        <div className="container mx-auto px-4 flex justify-between items-center">
          <Link href="/" className="flex items-center space-x-2">
            <FileText className="h-8 w-8 text-blue-600" />
            <span className="text-2xl font-bold text-gray-900">CV<span className="text-blue-600">Pro</span>CI</span>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Link href="/login">
              <Button variant="ghost" className="text-gray-700">Connexion</Button>
            </Link>
            <Link href="/register">
              <Button className="bg-blue-600 hover:bg-blue-700 shadow-lg hover:shadow-blue-500/30 transition-shadow">
                Créer mon CV
              </Button>
            </Link>
          </div>
      ...
      <section className="relative py-24 md:py-32 bg-gradient-to-br from-blue-50 to-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto">
              Des modèles optimisés pour le marché ivoirien. Augmentez vos chances d'être recruté par les meilleures entreprises d'Abidjan.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/register">
                <Button size="lg" className="bg-blue-600 hover:bg-blue-700 text-lg px-8 py-6 shadow-lg hover:shadow-blue-500/40 transition-all">
                  Créer mon CV gratuitement <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
              </Link>
              <Link href="/templates">
        ...
        <div className="container mx-auto px-4">
          <motion.div
              ...
              >
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Le CV : Votre passeport professionnel</h2>
              </motion.div>
              ...
              >
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-800 mb-2">Qu'est-ce qu'un CV ?</h3>
                      <p className="text-gray-600">
                        Le Curriculum Vitae (CV) est un document synthétique présentant votre parcours professionnel, 
                        vos compétences et formations. C'est votre première opportunité de faire bonne impression.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-800 mb-2">Pourquoi est-il crucial ?</h3>
                      <p className="text-gray-600">
                        En Côte d'Ivoire, 90% des recruteurs éliminent les candidats sur la base de leur CV avant même 
                        l'entretien. Un CV bien conçu multiplie par 5 vos chances d'être contacté.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-800 mb-2">Les attentes locales</h3>
                      <p className="text-gray-600">
                        Les recruteurs ivoiriens privilégient les CV clairs, structurés et mettant en avant 
                        les expériences pertinentes pour le poste. La photo professionnelle est souvent appréciée.
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Tout pour votre recherche d'emploi</h2>
            ...
            {[
              {
                ...
                description: "Choisissez parmi des dizaines de modèles adaptés aux attentes des recruteurs ivoiriens",
                color: "bg-blue-50"
              },
              {
                icon: <PenTool className="h-10 w-10 text-green-600" />,
                title: "Éditeur intuitif",
                description: "Personnalisez chaque détail de votre CV en quelques clics",
                color: "bg-green-50"
              },
              {
                icon: <Check className="h-10 w-10 text-purple-600" />,
                title: "Conseils experts",
                description: "Des suggestions pour améliorer votre CV selon votre secteur",
                color: "bg-purple-50"
              },
              {
                icon: <Download className="h-10 w-10 text-orange-600" />,
                title: "Téléchargement PDF",
                description: "Export haute qualité pour impression ou envoi par email",
                color: "bg-orange-50"
              },
              {
              ...
              },
              {
                ...
                description: "Inspirez-vous de modèles rédigés pour chaque métier",
                color: "bg-indigo-50"
              }
            ].map((feature, index) => (
              <motion.div
              ...
              >
                <Card className="h-full border-0 shadow-sm hover:shadow-md transition-all group">
                  <CardHeader>
                    <div className={`${feature.color} p-3 rounded-full w-12 h-12 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}>
                      {feature.icon}
                    </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Modèles adaptés au marché ivoirien</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Des designs modernes qui correspondent aux attentes des recruteurs locaux
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-gradient-to-br from-blue-600 to-indigo-700 text-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Ils ont trouvé un emploi avec CVPro CI</h2>
            ...
            {[
              {
                ...
                company: "SDV CI",
                testimonial: "Mon CV a retenu l'attention de plusieurs entreprises. J'ai signé un CDI 2 semaines après l'avoir mis en ligne.",
                rating: 5,
                delay: 0.1
              },
              {
                ...
                testimonial: "Les recruteurs ont particulièrement apprécié la clarté et le design professionnel de mon CV.",
                rating: 5,
                delay: 0.2
              },
              {
                ...
                company: "Orange CI",
                testimonial: "L'optimisation pour les systèmes ATS m'a permis d'être contacté par plusieurs cabinets de recrutement.",
                rating: 4,
                delay: 0.3
              }
              ...
              >
                <Card className="h-full bg-white/10 backdrop-blur-sm border-white/20 hover:bg-white/15 transition-colors">
                  ...
                  <CardContent>
                    ...
                    <div className="text-blue-100">{testimonial.position} • {testimonial.company}</div>
                  </CardContent>
                </Card>
              </motion.div>
            ))}
          ...
          <div className="flex flex-col lg:flex-row items-center">
            <div className="lg:w-1/2 mb-12 lg:mb-0 lg:pr-12">
              ...
              >
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Créez votre CV en 5 minutes</h2>
                <p className="text-xl text-gray-600 mb-8">
                  Notre outil intuitif vous guide pas à pas pour créer un CV qui vous représente parfaitement.
                </p>
  ...
  <section className="py-20 bg-gradient-to-b from-blue-50 to-white">
    <div className="container mx-auto px-4">
      ...
      >
        ...
        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Passez à la vitesse supérieure</h2>
        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
          Nos abonnements vous donnent accès à des fonctionnalités exclusives
        </p>
      </motion.div>
      ...
      <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
        {[
          ...
          <motion.div
            ...
            whileHover={{ y: -5 }}
          >
            <Card className={`h-full border-2 ${plan.color} ${plan.popular ? "shadow-lg ring-1 ring-blue-500" : "shadow-sm"} transition-all flex flex-col`}>
              <CardHeader>
                {plan.popular && (
                  <span className="bg-blue-600 text-white text-xs font-medium px-2 py-1 rounded-full inline-block mb-2">
                    Le plus choisi
                  </span>
                )}
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Vous avez des questions ?</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            ...
            {[
              {
                ...
                answer: "Oui, vous pouvez créer et télécharger votre CV gratuitement. Nous proposons également des options premium avec des fonctionnalités avancées."
              },
              {
                question: "Mes données sont-elles sécurisées ?",
                answer: "Absolument. Nous utilisons un chiffrement de pointe et ne partageons jamais vos informations avec des tiers."
              },
              {
                question: "Puis-je modifier mon CV plus tard ?",
                answer: "Oui, vous pouvez revenir à tout moment pour mettre à jour votre CV. Vos modifications sont sauvegardées automatiquement."
              },
              {
                question: "Y a-t-il des modèles en français ?",
                answer: "Tous nos modèles sont disponibles en français et adaptés aux standards des recruteurs ivoiriens."
              }
            ].map((item, index) => (
              <motion.div
                key={index}
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl mb-8 mx-auto">
              Rejoignez des milliers de professionnels ivoiriens qui utilisent CVPro CI pour leur recherche d'emploi
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4 max-w-md mx-auto">
              <Link href="/register">
                <Button size="lg" className="bg-white text-blue-600 hover:bg-gray-100 px-8 py-6 text-lg shadow-lg hover:shadow-xl transition-all">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
            <div className="lg:col-span-2">
              ...
              <p className="text-gray-400 mb-6">
                La solution de création de CV la plus utilisée en Côte d'Ivoire pour décrocher le job de vos rêves.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link href="/templates" className="text-gray-400 hover:text-white transition-colors">Modèles de CV</Link></li>
                <li><Link href="/examples" className="text-gray-400 hover:text-white transition-colors">Exemples de CV</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link href="/blog" className="text-gray-400 hover:text-white transition-colors">Conseils emploi</Link></li>
